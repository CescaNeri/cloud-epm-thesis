...
TO ADD: DESCRIPTION OF THE EPM CYCLE\\
...
The process begins with the collection of financial data from all the entities of the Group as illustrated in figure \ref{fig:dataload}.
%
