...
%
One crucial aspect of this process regards the creation of the dimensions that will be used to build reports from various perspectives which are used to categorize and structure information in order to obtain a complete view on the performance of the Group.
%
Dimensions are the building blocks of an EPM system; they serve as the axes along which data is organized and analyzed, providing a multidimensional view of financial and operational information. 
%
...
As we can see in figure \ref{fig:dimensions}, the activities of the group will be evaluated under five different dimensions of analysis: geography, product, brand and entity.
%
...
Once the dimensions have been defined, the next crucial step is to load and map the data within the EPM solution.
%
...
Figure \ref{fig:mapping} illustrates the relationship and the flow among various modeling elements:
%
...
%
This process involves applying various rules and calculations to ensure that data is accurate, complete, and consistent, by means of data validation, aggregation, translation, and consolidation, including adjustments for currency, intercompany eliminations, and other accounting practices.
%
